...
const handleQuizCompletion = () => {
  const result = { result: calculateResult(), user_id: user.id, quiz_type: "end" };
...
return (
  <div className="quiz-container">
    <h2 className="quiz-header">End Quiz</h2>
    <h3 className="quiz-subtitle">You completed the learning platform - hopefully you learned some new stuff. Lets test your knowledge.</h3>
